@extends('layouts.app', ['page' => __('Add New Member'), 'pageSlug' => 'members-new'])
                        ...
                        <form method="post" action="{{ route('members.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('lastname') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="lastname" id="input-lastname" class="form-control form-control-alternative{{ $errors->has('lastname') ? ' is-invalid' : '' }}" placeholder="{{ __('Last Name') }}" value="{{ old('lastname') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('address1') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="address1" id="input-address1" class="form-control form-control-alternative{{ $errors->has('address1') ? ' is-invalid' : '' }}" placeholder="{{ __('Address 1') }}" value="{{ old('address1') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('address2') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="address2" id="input-address2" class="form-control form-control-alternative{{ $errors->has('address2') ? ' is-invalid' : '' }}" placeholder="{{ __('Address 2') }}" value="{{ old('address2') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('postalcode') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="postalcode" id="input-postalcode" class="form-control form-control-alternative{{ $errors->has('postalcode') ? ' is-invalid' : '' }}" placeholder="{{ __('Postal Code') }}" value="{{ old('postalcode') }}" required>
                                ...
                                <div class="form-group{{ $errors->has('dispatch_date') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="date" name="dispatch_date" id="input-dispatch_date" class="form-control form-control-alternative{{ $errors->has('dispatch_date') ? ' is-invalid' : '' }}" placeholder="{{ __('Dispatch Date') }}" value="{{ old('dispatch_date') }}" required>
