                ...
                <div class="card-body">
                    <p class="card-text">
                        <div class="author">
                            ...
                            <a href="#">
                                <img class="avatar" src="{{ asset('white') }}/img/anime3.png" alt="">
                    ...
                    <div class="card-description text-center">
                        {{ _('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque elementum turpis ac placerat dapibus. Aenean condimentum et augue in luctus. Aliquam tristique porttitor sodales. Praesent sollicitudin ante dolor, ac efficitur felis sollicitudin vitae. Cras eget purus eu ante laoreet feugiat et sed eros. Nulla vitae nisi imperdiet, pulvinar tortor quis, varius felis...') }}
                    </div>
                </div>
                <div class="card-footer">
